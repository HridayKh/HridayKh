...
function Experiences() {
	return (
		<div>
			<h1 style={{ textDecoration: "none", color: "var(--prm)" }}>Experience</h1>
			<hr />

			<div style={{ marginBottom: "1.5em" }}>
				<h4 style={{ color: "var(--prm)" }}>Software Developer Intern</h4>
				<h6 style={{ color: "var(--scd)" }}>Tech Company XYZ | May 2023 - Aug 2023</h6>
				<p style={{ color: "var(--text)", fontSize: "0.75em", fontFamily: "Trebuchet MS, sans-serif" }}>
					- Developed and optimized React components for a real-time dashboard.<br />
					- Collaborated with the backend team to integrate RESTful APIs.<br />
					- Implemented unit tests, improving code reliability and coverage by 30%.
				</p>
			</div>

			<div style={{ marginBottom: "1.5em" }}>
				<h4 style={{ color: "var(--prm)" }}>Freelance Web Developer</h4>
				<h6 style={{ color: "var(--scd)" }}>Self-Employed | Jan 2023 - Apr 2023</h6>
				<p style={{ color: "var(--text)", fontSize: "0.75em", fontFamily: "Trebuchet MS, sans-serif" }}>
					- Designed and deployed responsive websites for small businesses.<br />
					- Integrated payment gateways and third-party services.<br />
					- Ensured cross-browser compatibility and improved site performance.
				</p>
			</div>

			<div>
				<h4 style={{ color: "var(--prm)" }}>Open Source Contributor</h4>
				<h6 style={{ color: "var(--scd)" }}>Various Projects | 2022 - Present</h6>
				<p style={{ color: "var(--text)", fontSize: "0.75em", fontFamily: "Trebuchet MS, sans-serif" }}>
					- Contributed to open-source projects, focusing on frontend and documentation.<br />
					- Reviewed and improved existing code for better readability.<br />
					- Helped onboard new contributors by creating clear, beginner-friendly guides.
				</p>
			</div>
		</div>
	);
